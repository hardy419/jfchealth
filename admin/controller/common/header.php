...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['home'] = $this->url->link('catalog/category', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['main_page'] = $this->url->link('catalog/mainpage_setting', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['course_customer'] = $this->url->link('catalog/course_customer', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['support'] = $this->url->link('catalog/support', 'token=' . $this->session->data['token'], 'SSL');
