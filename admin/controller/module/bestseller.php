...
class ControllerModuleBestSeller extends Controller {
	...
	public function index() {   
		...
		if (isset($this->request->post['bestseller_product'])) {
			$this->data['bestseller_product'] = $this->request->post['bestseller_product'];
		} else {
			$this->data['bestseller_product'] = $this->config->get('bestseller_product');
		}	

		$this->load->model('catalog/product');

		if (isset($this->request->post['bestseller_product'])) {
			$products = explode(',', $this->request->post['bestseller_product']);
		} else {		
			$products = explode(',', $this->config->get('bestseller_product'));
		}
