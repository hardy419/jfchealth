...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$this->data['entry_is_net'] = $this->language->get('entry_is_net');
		$this->data['entry_net_html'] = $this->language->get('entry_net_html');
		...
		if (isset($this->request->get['product_id'])) {
			...
			$this->data['id'] = file_get_contents(DIR_DOWNLOAD.'product/id');		
		}
		...
		if (isset($this->error['feature'])) {
			$this->data['error_feature'] = $this->error['feature'];
		} else {
			$this->data['error_feature'] = array();
		}	
		...
		if (isset($this->request->post['filename'])) {
			...
			$this->data['filename'] = $product_info['filename'];
		} else {
			$this->data['filename'] = '';
		}
		...
		if (isset($this->request->post['is_net'])) {
			$this->data['is_net'] = $this->request->post['is_net'];
		} elseif (!empty($product_info)) {
			$this->data['is_net'] = $product_info['is_net'];
		} else {
			$this->data['is_net'] = 1;
		}
