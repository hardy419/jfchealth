...
//$this->response->setOutput(var_export($this->error,1));return;
	...
	protected function getForm() {
		...
		if (isset($this->request->post['news_title'])) {
			$this->data['news_title'] = $this->request->post['news_title'];
		} elseif (isset($this->request->get['news_id'])) {
			$this->data['news_title'] = $this->model_catalog_news->getNewsDescriptions($this->request->get['news_id']);
		} else {
			$this->data['news_title'] = array();
		}

		if (isset($this->request->post['news_time'])) {
			$this->data['news_time'] = $this->request->post['news_time'];
		} elseif (isset($this->request->get['news_id'])) {
			$this->data['news_time'] = $this->model_catalog_news->getNewsDescriptions($this->request->get['news_id']);
		} else {
			$this->data['news_time'] = array();
		}
