      ...
      <tr>
        <td height="36" colspan="3" background="<?PHP echo $dir_image; ?>img_menu_bg.png"><table width="920" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="48" valign="middle">&nbsp;</td>
            <td width="60" valign="middle"><a href="product02.html" tppabs="http://jfchealth.com/new/product02.html" target="_parent"><img src="<?PHP echo $dir_image; ?>btn_menu_product.png" width="60" height="15" border="0" id="Image4" onmouseover="MM_swapImage('Image4','','<?PHP echo $dir_image; ?>btn_menu_product_mo.png',1)" onmouseout="MM_swapImgRestore()" /></a></td>
            <td width="48" valign="middle">&nbsp;</td>
            <td width="60" valign="middle"><a href="user_article.html" tppabs="http://jfchealth.com/new/user_article.html" target="_parent"><img src="<?PHP echo $dir_image; ?>btn_menu_sharing.png" name="Image5" width="60" height="15" border="0" id="Image5" onmouseover="MM_swapImage('Image5','','<?PHP echo $dir_image; ?>btn_menu_sharing_mo.png',1)" onmouseout="MM_swapImgRestore()" /></a></td>
            <td width="48" valign="middle">&nbsp;</td>
            <td width="60" valign="middle"><a href="magazine.html" tppabs="http://jfchealth.com/new/magazine.html" target="_parent"><img src="<?PHP echo $dir_image; ?>btn_menu_magazine.png" width="60" height="15" border="0" id="Image6" onmouseover="MM_swapImage('Image6','','<?PHP echo $dir_image; ?>btn_menu_magazine_mo.png',1)" onmouseout="MM_swapImgRestore()" /></a></td>
            <td width="48" valign="middle">&nbsp;</td>
            <td width="59" valign="middle"><a href="contactus.html" tppabs="http://jfchealth.com/new/contactus.html" target="_parent"><img src="<?PHP echo $dir_image; ?>btn_menu_contactus.png" width="59" height="15" border="0" id="Image7" onmouseover="MM_swapImage('Image7','','<?PHP echo $dir_image; ?>btn_menu_contactus_mo.png',1)" onmouseout="MM_swapImgRestore()" /></a></td>
