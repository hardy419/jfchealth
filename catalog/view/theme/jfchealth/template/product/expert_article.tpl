			...
			<table width="850" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td><table width="850" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
					<td width="850" align="left" valign="top" class="index_content_txt"><?PHP echo $news[0]['infod']; ?>......<span class="index_read_txt"><a href="?route=product/expert_article/detail&nid=<?PHP echo $news[0]['news_id']; ?>" target="_parent"><font color="#4e4eff">&lt;&lt;閱讀全文&gt;&gt;</font></a></span></td>
				  </tr>
				</table></td>
				</tr>
			<?PHP for ($idx=1; $idx<6; ++$idx) if(isset($news[$idx])) { ?>
			  ...
			  <tr>
				<td><table width="850" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
					<td width="850" align="left" valign="top" class="index_content_txt"><?PHP echo $news[$idx]['infod']; ?>...... <span class="index_read_txt"><a href="?route=product/expert_article/detail&nid=<?PHP echo $news[$idx]['news_id']; ?>" target="_parent"><font color="#4e4eff">&lt;&lt;閱讀全文&gt;&gt;</font></a></span><br />                                          </td>
				  </tr>
				</table></td>
				</tr>
			  <?PHP } else {break;} ?>
