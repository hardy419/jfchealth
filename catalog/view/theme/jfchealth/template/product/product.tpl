...
<div class="content">
	...
	<div class="right-content">
		<div class="content-title">
			<img src="<?PHP echo $detail_title_image; ?>" width="670" height="34"  border="0" usemap="#Map" />
			<map name="Map" id="Map">
		...
		<div class="content-detail">
			<div class="product-img">
				...
				<table width="310" border="0" cellpadding="0" cellspacing="0"><tr>
				  ...
				  ?>
					  <td><img style="cursor:pointer" src="<?PHP echo $images[$idx]['thumb']; ?>" width="90" height="102" onclick="changepic(<?PHP echo $idx; ?>);" /></td>
				  <?PHP
			...
			<div class="product-right-desc">
				...
				<p align="right" valign="top"><a href="?route=information/contactus" target="_parent"><img src="<?PHP echo $dir_image_lang; ?>btn_enquiry.png" width="163" height="46" border="0" /></a></p>
			</div>
