<?php 
class ControllerInformationCulture extends Controller {
	public function index() {
        ...
        $this->document->addStyle('catalog/view/theme/jfchealth/css/'.$this->language->get('code').'/aboutus.css');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/culture.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/information/culture.tpl';
		} else {
			$this->template = 'default/template/information/culture.tpl';
		}
