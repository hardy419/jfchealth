	...
	public function index() {
		...
		if ($product_info) {
			...
			if ($product_info['image']) {
				...
				$this->data['images'][] = array(
					'popup' => DIR_IMAGE.$product_info['image'],//$this->model_tool_image->resize($product_info['image'], $this->config->get('config_image_popup_width'), $this->config->get('config_image_popup_height')),
					'thumb' => DIR_IMAGE.$product_info['image']//$this->model_tool_image->resize($product_info['image'], $this->config->get('config_image_additional_width'), $this->config->get('config_image_additional_height'))
				);
			} else {
				$this->data['thumb'] = '';
			}
			...
			foreach ($results as $result) {
				$this->data['images'][] = array(
					'popup' => DIR_IMAGE.$result['image'],//$this->model_tool_image->resize($result['image'], $this->config->get('config_image_popup_width'), $this->config->get('config_image_popup_height')),
					'thumb' => DIR_IMAGE.$result['image']//$this->model_tool_image->resize($result['image'], $this->config->get('config_image_additional_width'), $this->config->get('config_image_additional_height'))
				);
			}
			...
			$this->data['feature'] = html_entity_decode($product_info['feature'], ENT_QUOTES, 'UTF-8');
			$this->data['filename'] = html_entity_decode($product_info['filename'], ENT_QUOTES, 'UTF-8');
            ...
            $this->document->addStyle('catalog/view/theme/jfchealth/css/'.$this->language->get('code').'/product.css');
