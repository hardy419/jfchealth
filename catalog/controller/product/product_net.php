<?php
class ControllerProductProductNet extends Controller {
	private $error = array();

	public function index() {
		$this->language->load('product/product_net');
		...
		if ($product_info) {
			...
			$this->document->addScript('catalog/view/theme/dared/js/marquee.js');
			$this->document->addScript('catalog/view/theme/dared/js/lightbox/js/lightbox.min.js');
			$this->document->addStyle('catalog/view/theme/dared/js/lightbox/css/lightbox.css');
			...
			$this->data['price_d'] = $product_info['price'];
			...
			$this->data['net_html'] = html_entity_decode($product_info['net_html'], ENT_QUOTES, 'UTF-8');
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/product_net.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/product/product_net.tpl';
			} else {
				$this->template = 'default/template/product/product_net.tpl';
			}
